...
#     zip = fields.Char()
#     city = fields.Char()
#     state = fields.Many2one('model.country.state', 'Fed. State', domain="[('country_id', '=', country)]")
#     country = fields.Many2one('model.country')
#     email = fields.Char()
#     phone = fields.Char()
...
#     partner_id = fields.Many2one('model.partner', 'Account Holder', ondelete='cascade', index=True, domain=['|', ('is_company', '=', True), ('parent_id', '=', False)], default=lambda self: self.env.user.company_id.partner_id)
#     bank_id = fields.Many2one('model.bank', string='Bank')
#     bank_name = fields.Char(related='bank_id.name')
#     bank_bic = fields.Char(related='bank_id.bic')
#     sequence = fields.Integer()
#     currency_id = fields.Many2one('model.currency', string='Currency')
#     company_id = fields.Many2one('model.company', 'Company', default=lambda self: self.env.user.company_id, ondelete='cascade')
#
#     _sql_constraints = [
